...
; WHEEL COUNTS
;-----------------------------------------------------------------------------
COUNTS_90_DEG   EQU 26               ; 90° turn
COUNTS_180_DEG  EQU 52               ; 180° turn
...
STEER_LEFT
            ; Robot is LEFT of line → turn LEFT to recenter ; Slow down left motor
            LDAA #MOTOR_SLOW
            LDAB #MOTOR_FAST
            JSR  SET_MOTOR_SPEEDS
            RTS
...
STEER_RIGHT
            ; Robot is RIGHT of line → turn RIGHT to recenter ; Slow down right motor
            LDAA #MOTOR_FAST
            LDAB #MOTOR_SLOW
            JSR  SET_MOTOR_SPEEDS
;=============================================================================
